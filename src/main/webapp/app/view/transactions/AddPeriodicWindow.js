Ext.define("TR.view.transactions.AddPeriodicWindow", {
    ...
    constructor : function(cfg) {
        ...
        var intervalsStore = Ext.StoreManager.lookup('intervalsStore') || Ext.create('TR.store.intervals.Store');
        ...
        var intervalField = {
            ...
            name : 'intervalTypeValue',
            allowBlank : false,
            format : '0',
            flex: 1
        };
        
        var intervalCombo = Ext.create('Ext.form.field.ComboBox', {
            name: 'intervalType',
            queryMode: 'local',
        ...
        var intervalInput = {
            ...
            layout: 'hbox',
            items: [ intervalField, intervalCombo ]
        };
